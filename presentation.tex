...
\begin{itemize}
  \item В работы исследованы различные метода восстановления карты проходимости с помощью наблюдений сонаров. Оказалось, что традиционные методы восстанавливают карты с грубыми ошибками, другие подходы невозможно использовать в режиме реального времени.

  \item В результате разработаны два новых метода картирования, предложена новая прямая модель сонара.
